...
function resultCarousel() {
  var $blocks = document.querySelectorAll(".block-result-carousel");
  if (!$blocks.length) return;
  $blocks.forEach(function ($block) {
    var swiperEl = $block.querySelector(".block-result-carousel__swiper");
    if (!swiperEl) return;
    var prevEl = $block.querySelector(".block-result-carousel__prev");
    var nextEl = $block.querySelector(".block-result-carousel__next");
    var currentEl = $block.querySelector(".block-result-carousel__current");
    var totalEl = $block.querySelector(".block-result-carousel__total");
    var swiper = new _swiper.default(swiperEl, {
...
var _default = exports.default = {
  init: function init() {
    ...
    // ======================
    document.addEventListener("click", function (e) {
      var item = e.target.closest(".pi-content-media .content-item");
      if (!item) return;
      var wrapper = item.closest(".pi-content-media");
      if (!wrapper) return;
      var left = wrapper.querySelector(".thumb-list");
      var indicator = left === null || left === void 0 ? void 0 : left.querySelector(".active-indicator");
      var mainImage = wrapper.querySelector(".main-image");
    ...
    window.addEventListener("load", function () {
      document.querySelectorAll(".pi-content-media").forEach(function (wrapper) {
        return initBlock(wrapper);
      });
    });
  }
};
},{}],"blocks/process-steps.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    document.addEventListener("click", function (e) {
      var _wrapper$querySelecto, _wrapper$querySelecto2;
      var tab = e.target.closest(".pi-process-steps .ps-tab");
      if (!tab) return;
      var wrapper = tab.closest(".pi-process-steps");
      if (!wrapper) return;
      var index = tab.dataset.index;

      // Update tabs
      wrapper.querySelectorAll(".ps-tab").forEach(function (t) {
        return t.classList.remove("is-active");
      });
      tab.classList.add("is-active");

      // Update panels
      wrapper.querySelectorAll(".ps-panel").forEach(function (p) {
        return p.classList.remove("is-active");
      });
      (_wrapper$querySelecto = wrapper.querySelector(".ps-panel[data-index=\"".concat(index, "\"]"))) === null || _wrapper$querySelecto === void 0 || _wrapper$querySelecto.classList.add("is-active");

      // Update images
      wrapper.querySelectorAll(".ps-img").forEach(function (img) {
        return img.classList.remove("is-active");
      });
      (_wrapper$querySelecto2 = wrapper.querySelector(".ps-img[data-index=\"".concat(index, "\"]"))) === null || _wrapper$querySelecto2 === void 0 || _wrapper$querySelecto2.classList.add("is-active");
    });
  }
};
},{}],"blocks/service-list.js":[function(require,module,exports) {
"use strict";
...
var _default = exports.default = {
  init: function init() {
    var blocks = document.querySelectorAll(".block-service-list");
    if (!blocks.length) return;
    blocks.forEach(function (block) {
      var items = block.querySelectorAll(".service-item");
      var previews = block.querySelectorAll(".service-preview");
...
},{}],"blocks/service-carousel.js":[function(require,module,exports) {
"use strict";
...
function initServiceCarousel() {
  var blocks = document.querySelectorAll(".block-service-carousel");
  if (!blocks.length) return;
  blocks.forEach(function (block) {
    var swiperEl = block.querySelector(".service-carousel__swiper");
    if (!swiperEl) return;
    var currentEl = block.querySelector(".service-carousel__current");
    var prevBtn = block.querySelector(".service-carousel__btn--prev");
    var nextBtn = block.querySelector(".service-carousel__btn--next");
    var spv = parseInt(swiperEl.dataset.slidesPerView, 10) || 3;
    var swiper = new _swiper.default(swiperEl, {
      modules: [_modules.Navigation],
      slidesPerView: spv,
      spaceBetween: 20,
...
},{"swiper":"../../node_modules/swiper/swiper.mjs","swiper/modules":"../../node_modules/swiper/modules/index.mjs"}],"blocks/technology.js":[function(require,module,exports) {
"use strict";
...
function initTechnology() {
  var blocks = document.querySelectorAll(".block-technology");
  if (!blocks.length) return;
  blocks.forEach(function (block) {
    var swiperEl = block.querySelector(".technology__swiper");
    if (!swiperEl) return;
    var prevBtn = block.querySelector(".technology__btn--prev");
    var nextBtn = block.querySelector(".technology__btn--next");
    var spv = parseInt(swiperEl.dataset.slidesPerView, 10) || 3;
...
},{"swiper":"../../node_modules/swiper/swiper.mjs","swiper/modules":"../../node_modules/swiper/modules/index.mjs"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _processSteps = _interopRequireDefault(require("./blocks/process-steps"));
var _serviceList = _interopRequireDefault(require("./blocks/service-list"));
var _serviceCarousel = _interopRequireDefault(require("./blocks/service-carousel"));
var _technology = _interopRequireDefault(require("./blocks/technology"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
  ...
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        ...
        _processSteps.default.init();
        _serviceList.default.init();
        _serviceCarousel.default.init();
        _technology.default.init();
      case 1:
        return _context.a(2);
    }
  }, _callee);
})));
},{"./functions":"functions.js","./blocks/counter":"blocks/counter.js","./blocks/carousel-slider":"blocks/carousel-slider.js","./blocks/insights":"blocks/insights.js","./blocks/team":"blocks/team.js","./blocks/sectors":"blocks/sectors.js","./blocks/content-media":"blocks/content-media.js","./blocks/process-steps":"blocks/process-steps.js","./blocks/service-list":"blocks/service-list.js","./blocks/service-carousel":"blocks/service-carousel.js","./blocks/technology":"blocks/technology.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
