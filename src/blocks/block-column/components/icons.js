...
/* Three column - 40/20/40. */
icons.threeSmallCenter = (
	<svg
		viewBox="0 0 60 30"
		height="26"
		xmlns="http://www.w3.org/2000/svg"
		...
		strokeMiterlimit="1.414"
	>
		<rect x="0" y="0" width="20" height="30" fill="#6d6a6f" />
		<rect x="24" y="0" width="11" height="30" fill="#6d6a6f" />
		<rect x="40" y="0" width="20" height="30" fill="#6d6a6f" />
	</svg>
);
